...
module.exports = (api: Express) => {
  ...
  api
    .route('/v1/users/:userId/chatSettings')
    .put(validation.user.chatSettings, wrapAsync(UsersAPI.updateUserChatSettings))
  ...
  api
    .route('/v1/users/:userId/toggleNotificationSetting')
    .put(validation.user.notification, wrapAsync(UsersAPI.toggleNotificationSetting))
  api.route('/v1/users/:userId/wishlist').get(wrapAsync(ProductsAPI.getUserWishlist))
  api
    .route('/v1/users/:userId/register')
    .put(validation.user.register, wrapAsync(UsersAPI.registerUser))
  api.route('/v1/users/:userId/verify').put(validation.user.verify, wrapAsync(UsersAPI.verifyUser))
  api
    .route('/v1/users/:userId/unverify')
    .put(validation.user.unverify, wrapAsync(UsersAPI.unverifyUser))
  ...
  api
    .route('/v1/shops/:shopId/operatingHours')
    .put(validation.shop.operatingHours, wrapAsync(ShopsAPI.addShopOperatingHours))
  ...
  api
    .route('/v1/invite/:inviteId')
    .put(validation.invite.update, wrapAsync(InvitesAPI.updateInvite))
  ...
  api
    .route('/v1/community')
    .post(validation.community.create, wrapAsync(CommunityAPI.createCommunity))
  api.route('/v1/community/:communityId').get(wrapAsync(CommunityAPI.getCommunity))
  api
    .route('/v1/community/:communityId')
    .put(validation.community.update, wrapAsync(CommunityAPI.updateCommunity))
  ...
  api
    ...
    .put(validation.product.update, wrapAsync(ProductsAPI.updateProduct))
  ...
  api
    .route('/v1/products/:productId/availability')
    .get(wrapAsync(ProductsAPI.getProductAvailability))
  api
    .route('/v1/products/:productId/availability')
    .put(validation.product.availability, wrapAsync(ProductsAPI.addProductAvailability))
  ...
  api
    ...
    .post(validation.product.review, wrapAsync(ProductsAPI.addProductReview))
  api
    .route('/v1/products/:productId/report')
    .post(validation.product.report, wrapAsync(ProductsAPI.reportProduct))

  // -- Categories routes
  api.route('/v1/categories').get(wrapAsync(CategoriesAPI.getCategories))
  api
    .route('/v1/categories')
    .post(validation.category.create, wrapAsync(CategoriesAPI.createCategory))
  api.route('/v1/categories/:categoryId').get(wrapAsync(CategoriesAPI.getCategory))
  api
    .route('/v1/categories/:categoryId')
    .put(validation.category.update, wrapAsync(CategoriesAPI.updateCategory))
  ...
  api
    .route('/v1/activities')
    .post(validation.activity.create, wrapAsync(ActivitiesAPI.createActivity))
  api.route('/v1/activities/:activityId').get(wrapAsync(ActivitiesAPI.getActivity))
  api
    .route('/v1/activities/:activityId')
    .put(validation.activity.update, wrapAsync(ActivitiesAPI.updateActivity))
  ...
  api
    .route('/v1/activities/:activityId/report')
    .post(validation.activity.report, wrapAsync(ActivitiesAPI.reportActivity))

  // -- Comments routes
  api.route('/v1/comments').get(searchMiddleware, wrapAsync(CommentsAPI.getComments))
  api.route('/v1/activities/:activityId/comments').get(wrapAsync(CommentsAPI.getActivityComments))
  api
    .route('/v1/activities/:activityId/comments')
    .post(validation.comment.create, wrapAsync(CommentsAPI.createComment))
  api.route('/v1/activities/:activityId/comments/:commentId').get(wrapAsync(CommentsAPI.getComment))
  api
    .route('/v1/activities/:activityId/comments/:commentId')
    .put(validation.comment.update, wrapAsync(CommentsAPI.updateComment))
  api
    .route('/v1/activities/:activityId/comments/:commentId')
    .delete(wrapAsync(CommentsAPI.archiveComment))
  api
    .route('/v1/activities/:activityId/comments/:commentId/unarchive')
    .put(wrapAsync(CommentsAPI.unarchiveComment))
  ...
  api
    .route('/v1/activities/:activityId/comments/:commentId/like')
    .post(wrapAsync(LikesAPI.likeComment))
  api
    .route('/v1/activities/:activityId/comments/:commentId/unlike')
    .delete(wrapAsync(LikesAPI.unlikeComment))
  ...
  api
    ...
    .get(conversationSearchMiddleware, wrapAsync(ChatsAPI.getConversations))
  api.route('/v1/chats').post(validation.chat.create, wrapAsync(ChatsAPI.createChat))
  api
    .route('/v1/chats/:chatId/conversation')
    .post(validation.chat.conversation, wrapAsync(ChatsAPI.createConversation))
  api.route('/v1/chats/:chatId/invite').put(validation.chat.invite, wrapAsync(ChatsAPI.chatInvite))
  api
    .route('/v1/chats/:chatId/removeUser')
    .put(validation.chat.removeUser, wrapAsync(ChatsAPI.chatRemoveUser))
  api
    .route('/v1/chats/:chatId/updateTitle')
    .put(validation.chat.title, wrapAsync(ChatsAPI.updateChatTitle))
  api
    .route('/v1/chats/:chatId/conversation/:messageId')
    .delete(wrapAsync(ChatsAPI.archiveChatMessage))
  ...
  api
    .route('/v1/orders/:orderId/decline')
    .put(validation.order.decline, wrapAsync(OrdersAPI.decline))
  api.route('/v1/orders/:orderId/cancel').put(validation.order.cancel, wrapAsync(OrdersAPI.cancel))
  api
    .route('/v1/orders/:orderId/products/:productId/review')
    .post(validation.order.review, wrapAsync(OrdersAPI.addOrderProductReview))

  // -- Product Subscription Plans routes
  api
    .route('/v1/productSubscriptionPlans')
    .get(orderSearchMiddleware, wrapAsync(ProductSubscriptionPlansAPI.getProductSubscriptionPlans))
  api
    .route('/v1/productSubscriptionPlans')
    .post(
      validation.productSubscriptionPlan.create,
      wrapAsync(ProductSubscriptionPlansAPI.createProductSubscriptionPlan)
    )
  api
    .route('/v1/productSubscriptionPlans/:planId/autoRescheduleConflicts')
    .post(wrapAsync(ProductSubscriptionPlansAPI.autoRescheduleConflicts))
  api
    .route('/v1/productSubscriptionPlans/:planId/confirm')
    .put(wrapAsync(ProductSubscriptionPlansAPI.confirm))
  api
    .route('/v1/productSubscriptionPlans/:planId/disable')
    .put(wrapAsync(ProductSubscriptionPlansAPI.disableProductSubscriptionPlan))
  api
    .route('/v1/productSubscriptionPlans/:planId/overrideDates')
    .put(
      validation.productSubscriptionPlan.overrideDates,
      wrapAsync(ProductSubscriptionPlansAPI.overrideDates)
    )
  api
    .route('/v1/productSubscriptionPlans/:planId/cancel')
    .put(wrapAsync(ProductSubscriptionPlansAPI.cancel))
  api
    .route('/v1/productSubscriptionPlans/:planId/unsubscribe')
    .put(wrapAsync(ProductSubscriptionPlansAPI.unsubscribe))
  api
    .route('/v1/productSubscriptionPlans/:planId/getDates')
    .get(wrapAsync(ProductSubscriptionPlansAPI.getDates))

  // -- Product Subscriptions routes
  api
    .route('/v1/productSubscriptions/:id/createOrder')
    .post(
      validation.productSubscription.order,
      wrapAsync(ProductSubscriptionsAPI.createOrderFromSubscription)
    )
