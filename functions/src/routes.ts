...
module.exports = (api: Express) => {
  ...
  api.route('/v1/shops/getCommunityShops').get(wrapAsync(ShopsAPI.getCommunityShops))
  ...
  api.route('/v1/products/getUserProducts').get(wrapAsync(ProductsAPI.getUserProducts))
  api.route('/v1/products/getCommunityProducts').get(wrapAsync(ProductsAPI.getCommunityProducts))
